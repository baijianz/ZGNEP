#ifndef ZGNEP_VIDEO_H
#define ZGNEP_VIDEO_H
#include <QMainWindow>
...
class zgnep_video : public QMainWindow
{
    Q_OBJECT

public:
    zgnep_video(QWidget *parent = nullptr, QString dir = "", QString path = "");
    ~zgnep_video();
...
private:
    ...
    /* 扫描本地视频文件 */
    void scanVideoFiles(QString pdir, QString path);
