...
public:
    ...
    void setupUi(QDialog *zgnep_messageBox_input)
    {
        ...
        zgnep_messageBox_input->resize(400, 204);
        ...
        btn_cancel->setGeometry(QRect(290, 110, 70, 30));
        ...
        widget->setGeometry(QRect(10, 20, 371, 27));
