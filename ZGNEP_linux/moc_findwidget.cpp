...
#include "fileSystem/findwidget.h"
...
QT_MOC_LITERAL(4, 31, 16), // "animateFindClick"
QT_MOC_LITERAL(5, 48, 6), // "browse"
QT_MOC_LITERAL(6, 55, 4), // "find"
QT_MOC_LITERAL(7, 60, 15), // "onCellActivated"
QT_MOC_LITERAL(8, 76, 3), // "row"
QT_MOC_LITERAL(9, 80, 6), // "column"
QT_MOC_LITERAL(10, 87, 11), // "contextMenu"
QT_MOC_LITERAL(11, 99, 3) // "pos"

    },
    "FindWidget\0cellActivated\0\0name\0"
    "animateFindClick\0browse\0find\0"
    "onCellActivated\0row\0column\0contextMenu\0"
    "pos"
};
...
void FindWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cellActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->animateFindClick(); break;
        case 2: _t->browse(); break;
        case 3: _t->find(); break;
        case 4: _t->onCellActivated((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (FindWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FindWidget::cellActivated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FindWidget::cellActivated(const QString & _t1)
{
