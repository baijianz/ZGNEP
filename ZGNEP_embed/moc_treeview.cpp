...
QT_MOC_LITERAL(1, 9, 16), // "treeViewGotFocus"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "TreeView\0treeViewGotFocus\0"
};
...
void TreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->treeViewGotFocus(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TreeView::treeViewGotFocus)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TreeView::treeViewGotFocus()
{
