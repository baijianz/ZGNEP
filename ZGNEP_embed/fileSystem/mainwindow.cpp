    ...
    : QMainWindow(parent)
{
    ...
    setWindowTitle(tr("zgnep_fileSystem 文件系统"));
    MAINMODEL = this;
...
void MainWindow::fileModelInit()
{
   ...
   //fileModel->setOption(QFileSystemModel::DontWatchForChanges);  //不要再监视文件变化
#endif
...
void MainWindow::setupMenuBar()
{
    ...
    QAction *exitAction = fileMenu->addAction(tr("E&xit"), qApp, [&](){this->close();}, Qt::QueuedConnection);
