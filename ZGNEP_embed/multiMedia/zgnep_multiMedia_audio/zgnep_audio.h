#ifndef ZGNEP_AUDIO_H
#define ZGNEP_AUDIO_H
...
class zgnep_audio : public QMainWindow
{
    Q_OBJECT

public:
    zgnep_audio(QWidget *parent = nullptr, QString dir = "", QString file = "");
    ~zgnep_audio();
...
private:
    ...
    /* 扫描歌曲 */
    void scanSongs(QString path, QString file);
