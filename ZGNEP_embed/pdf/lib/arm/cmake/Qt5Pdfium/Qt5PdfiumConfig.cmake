...
if (CMAKE_VERSION VERSION_LESS 3.1.0)
    message(FATAL_ERROR "Qt 5 Pdfium module requires at least CMake version 3.1.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/cmake/Qt5Pdfium" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Pdfium_install_prefix "/usr/lib/../" ABSOLUTE)
else()
...
macro(_populate_Pdfium_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Pdfium PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt5Pdfium.so.5"
...
if (NOT TARGET Qt5::Pdfium)
    ...
    set(_Qt5Pdfium_OWN_INCLUDE_DIRS "${_qt5Pdfium_install_prefix}/include/" "${_qt5Pdfium_install_prefix}/include/QtPdfium")
    ...
    # specified.
    list(FIND Qt5Pdfium_FIND_COMPONENTS Private _check_private)
    if (NOT _check_private STREQUAL -1)
        foreach(_dir ${Qt5Pdfium_PRIVATE_INCLUDE_DIRS})
            _qt5_Pdfium_check_file_exists(${_dir})
        endforeach()
    endif()
    ...
    set_property(TARGET Qt5::Pdfium PROPERTY INTERFACE_QT_ENABLED_FEATURES )
    set_property(TARGET Qt5::Pdfium PROPERTY INTERFACE_QT_DISABLED_FEATURES )
    ...
    _populate_Pdfium_target_properties(DEBUG "libQt5Pdfium.so.5.5.0" "" )
    ...
    macro(_populate_Pdfium_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Pdfium_install_prefix}/lib/plugins/${PLUGIN_LOCATION}")
        _qt5_Pdfium_check_file_exists(${imported_location})
